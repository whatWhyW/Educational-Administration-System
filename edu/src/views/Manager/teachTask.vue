	...
	<div>
		...
		<el-row>
			...
			<div class="searchbox" style="display: inline-block; float: right;">
				<input class="sc" type="text" placeholder="请输入课程名" style="width: 300px; margin-right: 20px; height: 32px; border-radius: 1px solid #302d1c; margin-bottom: -3px; position: relative; top: 3px;"/>
...
methods: {
  ...
  sortUp() {
  	var objectArraySort = function (keyName) {
    	...
    	// console.log('升序')
    	this.tableData.sort(objectArraySort('date'))
